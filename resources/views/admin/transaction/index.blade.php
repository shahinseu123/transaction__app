            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                <thead>
                    <tr>
                        ...
                        <th class="text-left" data-priority="4">Transection Number</th>
                        <th class="text-left" data-priority="2">Date</th>
                        <th class="text-left" data-priority="4">Type</th>
                        <th class="text-left" data-priority="4">Particular</th>
                        <th class="text-left" data-priority="4">Amount</th>
                    ...
                    @if ($trans)
                        @foreach ($trans as $item)
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{ route('transaction.edit', $item->id) }}"><i
                                            class="fas fa-edit"></i></a>
                                    <a href="{{ route('transaction.delete', $item->id) }}"><i
